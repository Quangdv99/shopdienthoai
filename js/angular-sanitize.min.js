    ...
    .provider(
        ...
        function() {
          ...
          this.addValidElements = function(a) {
            y ||
                (H(a) && (a = {htmlElements: a}), t(l, a.svgElements),
                 t(r, a.htmlVoidElements), t(m, a.htmlVoidElements),
                 t(m, a.htmlElements));
            return this
          };
          ...
          var z = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g, u = /([^#-~ |!])/g,
              ...
              x = h(
                  {}, x,
                  f('address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,section,table,ul')),
              p = h(
                  {}, p,
                  f('a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var')),
              l = f(
              ...
              p = f(
                  ...
                  !0),
              M = h({}, O, p, n), N = function(a, e) {
                function d(b) {
                  b = '<remove></remove>' + b;
                  try {
                    var d =
                        (new a.DOMParser).parseFromString(b, 'text/html').body;
                    d.firstChild.remove();
                    return d
                  } catch (e) {
                  }
                ...
                if (e && e.implementation)
                  ...
                  throw D('noinert');
                var c = (g.documentElement || g.getDocumentElement())
                            .querySelector('body');
                c.innerHTML =
...
c.module('ngSanitize').filter('linky', [
  ...
  function(f) {
    var h = /((s?ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i,
        t = /^mailto:/i, q = c.$$minErr('linky'), s = c.isDefined,
        A = c.isFunction, v = c.isObject, y = c.isString;
    return function(c, z, u) {
      ...
      for (var p = A(u) ? u : v(u) ? function() {
        ...
        w = c[0], c[2] || c[4] || (w = (c[3] ? 'http://' : 'mailto:') + w),
        m = c.index, r(n.substr(0, m)), x(w, c[0].replace(t, '')),
